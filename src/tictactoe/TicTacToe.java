...
/**
 * Una classe que te tots el metodes per a crear el joc TicTacToe
 * @author andreu.reyfor.dam_al
 * @version 28.02.2023
 */
public class TicTacToe {
     ...
     * @param taulerJoc es el que emaggatzema les cel·les d'un tauler del joc tic tac toe.
     */
    ...
    /**
     * Retorna diferents caràcters segons el parametre 'i' del mètode
     * Si el símbol es 'O' es la cel·la del contrincant; si el símbol es 'X' es la cel·la del jugador; si el símbol es '_' la cel·la no pertany a ningú;
     * @param i contingut element del tauler joc
     * @return Símbol '_' si la i=-3; símbol 'O' si la i=0; símbol 'X' si i!=0; 
     */
    ...
    /**
     * Tradueix els elements del tauler en forma bidimensional a unidimensional
     * De la posicio 0,0 passaria a 0; de 0,1 passaria a 1; de 0,2 passaria a 2; de 0,3 passaria a 3; de 1,0 passaria a 4; i axi continuament
     * y,x -> Return
     * 0,0 -> 0
     * 0,1 -> 1
     * 0,2 -> 2
     ...
     * 1,0 -> 4
     * 1,1 -> 5
     * @param x es la segon índex de l'array
     * @param y es la primer índex de l'array 
     * @return Un index del array unidimensional que representa els index de l'array bidimensional.
     */    
    ...
    /**
     * Crea la posicio del contrincant en el tauler joc
     * En el cas de que la posicio ja tingui un símbol buscara una nova posició pero si la posicio esta buida treura el símbol 'O'
     * @param taulerJoc 
     */
    ...
    /**
     * Crea la posicio del jugador en el tauler joc
     * Imprimira el símbol 'X' en la posiscio que el jugador seleccioni
     * @param taulerJoc 
     */
